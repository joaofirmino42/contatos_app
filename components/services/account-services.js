...
//função para execuatr uma chamada POST para o serviço
//de recuperação de senha de usuários da API
...
//função para executar uma chamada POSTA PARA o serviço
//de recuperação de senha de usuários da APi
export const postPssword = (data) => {
    //utilizando o AXIOS para fazer requisição POST
